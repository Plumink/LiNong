...
export default class GoodsSearch extends Component {

    constructor(props){
        super(props);
        this.state = {
            searchValue:this.props.param1,
            content:{}
        }
    }
    ...
    searchRes = () => {
        fetch('http://175.24.100.139:8081/getSearch?searchRes='+this.state.searchValue)
            .then((res)=>res.json())
            .then(
                data => {
                    this.setState({
