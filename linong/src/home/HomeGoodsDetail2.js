...
export default class GoodsDetail2 extends Component {
    render() {
        return (
            <View style={{backgroundColor:'##a9a9a9',width:'100%',height:'100%'}}>
                ...
                <View style={{width:'100%',height:480*s}}>
                    <Swiper autoplay={true} style={{padding:0}} showsPagination={false}>
                        <Image source={{uri:'https://s1.ax1x.com/2020/06/03/tUlcmF.png'}}  style={{height:'120%',width:'100%'}}/>
                        <Image source={{uri:'https://s1.ax1x.com/2020/06/03/tUl2TJ.png'}} style={{height:'120%',width:'100%'}}/>
                        <Image source={{uri:'https://s1.ax1x.com/2020/06/03/tUlfYR.png'}} style={{height:'120%',width:'100%'}}/>
                    </Swiper>
                </View>
                ...
                <View style={{width:'100%',height:200*s,backgroundColor:'#FFFFFF'}}>
                    ...
                    <Text style={{color:'#ff4500',fontSize:35*s,position:'absolute',top:10*s,left:55*s}}>10.0</Text>
                    ...
                    <View style={{width:75*s,height:28*s,backgroundColor:'rgb(255,80,1)',position:'absolute',top:22*s,left:180*s}}>
                        <Text style={{color:'white',fontSize:18*s,paddingTop:2*s}}>50斤起</Text>
                    </View>
                    <Text style={{fontSize:24*s,position:'absolute',top:60*s,left:30*s}}>湖北武汉淡水湖，优质小龙虾</Text>
                    ...
                    />
                    <Text style={{color:'rgb(117,117,117)',fontSize:16*s,position:'absolute',top:136*s,left:50*s}}>湖北省武汉市华中养殖场</Text>
                    <Icon2
                        color='rgb(117,117,117)'
                        name='update'
                ...
                <View style={{width:'100%',height:190*s,marginTop:10*s,backgroundColor:'#FFFFFF'}}>
                    ...
                    <Text style={{color:'rgb(100,100,100)',fontSize:20*s,position:'absolute',top:20*s,left:180*s}}>小青</Text>
                    <Text style={{color:'rgb(100,100,100)',fontSize:20*s,position:'absolute',top:80*s,left:180*s}}>中青</Text>
                    <Text style={{color:'rgb(100,100,100)',fontSize:20*s,position:'absolute',top:140*s,left:180*s}}>大青</Text>
                    <Text style={{color:'rgb(100,100,100)',fontSize:20*s,position:'absolute',top:20*s,left:480*s}}>8.00元/斤</Text>
                    <Text style={{color:'rgb(100,100,100)',fontSize:20*s,position:'absolute',top:80*s,left:480*s}}>10.00元/斤</Text>
                    <Text style={{color:'rgb(100,100,100)',fontSize:20*s,position:'absolute',top:140*s,left:480*s}}>14.00元/斤</Text>
                </View>
                {/* 交易信息 */}
